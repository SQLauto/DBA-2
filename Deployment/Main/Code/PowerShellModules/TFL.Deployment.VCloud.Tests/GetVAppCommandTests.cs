...
{
    [TestClass]
    public class GetVAppCommandTests
    {
        ...
        {
            PsCmdletAssert.Invoke(typeof(GetVAppCommand), new[] { new Parameter("Url", "SomeValue") });
        }
        ...
        {
            PsCmdletAssert.Invoke(typeof(GetVAppCommand), new[] { new Parameter("RigName", null), new Parameter("Url", "SomeValue") });
        }
        ...
        {
            PsCmdletAssert.Invoke(typeof(GetVAppCommand), new[] { new Parameter("RigName", ""), new Parameter("Url", "SomeValue") });
        }

        [TestMethod]
        [TestCategory("vCloud")]
        public void TestReturnsVApp()
        {
            ...
            Assert.IsTrue(vApp.Resource.name.Equals("IPP.Regression"));
