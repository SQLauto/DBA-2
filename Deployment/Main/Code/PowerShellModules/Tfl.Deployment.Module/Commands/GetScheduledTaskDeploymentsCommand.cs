...
{
    [Cmdlet(VerbsCommon.Get, "ScheduledTaskDeployments", DefaultParameterSetName = "Existing")]
    public class GetScheduledTaskDeploymentsCommand : PSCmdletBase
    {
        ...
        public global::Deployment.Domain.Deployment InputObject { get; set; }

        [Parameter]
        [Alias("Groups")]
        public global::Deployment.Domain.GroupFilters GroupFilters { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            InputObject = deploymentService.GetScheduledTaskDeployments(InputObject);
