...
{
    [Cmdlet(VerbsCommon.Get, "ServiceDeployments", DefaultParameterSetName = "Existing")]
    public class GetServiceDeploymentsCommand : PSCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            InputObject = deploymentService.GetServiceDeployments(InputObject);
