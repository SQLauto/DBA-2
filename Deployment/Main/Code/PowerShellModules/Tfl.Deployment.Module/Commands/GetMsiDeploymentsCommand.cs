...
{
    [Cmdlet(VerbsCommon.Get, "MsiDeployments", DefaultParameterSetName = "Existing")]
    public class GetMsiDeploymentsCommand : PSCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            InputObject = deploymentService.GetMsiDeployments(InputObject);
