...
{
    [Cmdlet(VerbsCommon.Remove, "VApp", DefaultParameterSetName = "ByApp")]
    public class RemoveVAppCommand : PSCmdletBase
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var result = ParameterSetName.Equals("ByApp") ? vCloudService.DeleteVApp(VApp, logger) : vCloudService.DeleteVApp(RigName, logger);
