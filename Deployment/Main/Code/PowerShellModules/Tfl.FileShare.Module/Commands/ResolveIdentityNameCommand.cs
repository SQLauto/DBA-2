...
{
    [Cmdlet(VerbsDiagnostic.Resolve, "IdentityName", DefaultParameterSetName = "ByName")]
    public class ResolveIdentityNameCommand : PSCmdlet
    {
