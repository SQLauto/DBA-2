...
namespace Tfl.Module.Testing
{
    ...
    {
        private const string ContractExceptionFullname = "System.Diagnostics.Contracts.__ContractsRuntime+ContractException";
        ...
        protected override void Verify(Exception exception)
        {
            ...
            if (exception.GetType().FullName == ContractExceptionFullname)
            {
