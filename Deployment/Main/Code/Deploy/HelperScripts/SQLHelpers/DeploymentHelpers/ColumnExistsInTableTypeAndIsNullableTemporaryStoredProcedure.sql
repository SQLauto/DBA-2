create proc #ColumnExistsInTableTypeAndIsNullable
...
begin
	...
	begin
		raiserror('#ColumnExistsInTableTypeAndIsNullable procedure was called with one or more null arguments', 16, 1)
	end
