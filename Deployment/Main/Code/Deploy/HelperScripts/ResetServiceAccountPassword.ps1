#todo use: $ensureAccountIsAutomatic, $mandatory, $serviceAccountName
param (
  [alias('computer')]
  [string] $computerName = $env:COMPUTERNAME,
  [alias('setAutoStart')]
  [bool] $ensureAccountIsAutomatic = $false,
  [alias('start')]
...
} -ArgumentList $computerName, $ensureAccountIsAutomatic, $serviceAccountName, $serviceUsername, $servicePassword