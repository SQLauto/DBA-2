...
namespace LabManager
{
    ...
    public sealed class DeployConfiguration : CodeActivity<Boolean>
    {
        ...
        protected override bool Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                if (targetConfigID > 0)
                {
                    ...
                    labManagerService.Client.ConfigurationDeploy(labManagerService.AuthHeader, targetConfigID, false, 2 ); // 4 = FenceAllowInAndOut
                    context.TrackBuildMessage(string.Format("Shutdown configuration id={0}", targetConfigID), BuildMessageImportance.Normal);
                }
