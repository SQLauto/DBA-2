CREATE PROCEDURE [dbo].[SendAccountVerification]
	...
	@Amount int, 
	@PaymentCardApplicationTransactionCounter int, --posiably not the best way to do this
...
AS
	...
	DECLARE @Message XML([http://tfl.gov.uk/Ft/Pare/Authorisation/Schema/AccountVerification/Request/v1]);

	EXEC [dbo].[CreateAccountVerificationRequest]
	...
	DECLARE @MessageType SYSNAME = 'http://tfl.gov.uk/Ft/Pare/Authorisation/Message/AccountVerification/Request';
