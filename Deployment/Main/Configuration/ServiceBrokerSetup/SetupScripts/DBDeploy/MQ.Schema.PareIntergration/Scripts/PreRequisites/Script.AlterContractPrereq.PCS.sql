...
IF EXISTS (select * from sys.services where [name] = 'http://tfl.gov.uk/Ft/Pare/DirectPayment/Service/Pcs')
	DROP SERVICE [http://tfl.gov.uk/Ft/Pare/DirectPayment/Service/Pcs]
GO