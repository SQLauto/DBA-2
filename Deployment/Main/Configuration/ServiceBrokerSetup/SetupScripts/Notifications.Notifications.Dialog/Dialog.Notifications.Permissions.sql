ALTER AUTHORIZATION ON SERVICE::[http://tfl.gov.uk/Ft/Notification/Service/Email] TO TargetEmailNotificationDialogUser;

GRANT SEND ON SERVICE::[http://tfl.gov.uk/Ft/Notification/Service/Email] TO PareEmailNotificationDialogUser;
