...
Script Name: 2a_Travelstore_cpc_copy_travel_schema_data.sql

TO BE RUN in Travelstore_CPC Database on VINS001 
This will populate "_new" tables for travel and archive schemas 

It should be run in parallel with 2b_Travelstore_copy_travel_schema_data.sql
