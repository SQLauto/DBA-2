...
-- Changes Refunds.Refund column "Source" datatype back to nvarchar(20) from the value of varchar(10)
...
ALTER Table [refunds].[refund] alter column "Source" nvarchar(20) not null
GO
