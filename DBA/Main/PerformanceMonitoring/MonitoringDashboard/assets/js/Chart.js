...
(function() {
	...
	var LinearRadialScale = Chart.Element.extend({
		...
		getIndexAngle: function(index) {
			...
			// Start1 from the top instead of right, so remove a quarter of the circle
